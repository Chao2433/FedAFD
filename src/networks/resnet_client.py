...
class ResNet(nn.Module):
    def __init__(self, block, layers, **kwargs):
        ...
        # self.class_fc_cla = nn.Linear(512,100)
        self.class_fc_2 = nn.Linear(self.embed_dim, kwargs['num_class'])  # 2*self.embed_dim
